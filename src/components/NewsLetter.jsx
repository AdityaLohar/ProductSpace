  ...
  return (
    <div className="flex flex-col bg-white pb-5 lg:pb-10">
      ...
      <div className="flex justify-center items-center mt-0 lg:mt-10 px-4">
        <div className="flex justify-between items-center bg-[#AEECFF] rounded-full p-1 lg:p-2 mx-2 lg:mx-0 w-full lg:w-3/5">
          <input type="text" placeholder="Enter your Email Id" className="px-3 rounded-full text-gray-800 w-1/2 lg:w-2/3 placeholder-black bg-[#AEECFF]" />
