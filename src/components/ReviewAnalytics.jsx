...
const ReviewCardSmall = ({
  ...
  return (
    ...
    >
      <div
        className="flex flex-col relative gap-2 bg-white border border-2 border-transparent 
        hover:border-[#C3C3C3] rounded-lg p-4 py-6 h-full"
      >
        <div>
  ...
  return (
    <div className="flex flex-col pt-3 lg:pt-0 rounded-lg">
      <div className="py-5 lg:py-12">
        ...
        <div className="pm-reviews-scrollbar flex overflow-x-scroll gap-6 pt-8 pl-4 md:pl-8 pb-4">
